...
**Burokku** is a all-in-one Web3 dashboard, it's a Web3 search engine, a Web3 information aggregator, a Web3 portfolio tracker, and more. We will be launching soon, join the
Waitlist [here](https://burokku.one) now.

## Burokku what?

Today, we are launching **Burokku** ("block" in Japanese), a all-in-one Web3 Dashborad. Although we are still in development,
...
### It's a all-in-one Web3 Dashboard

**Burokku** is a all-in-one Web3 Dashboard that's super customizable, it provides you with many super cool widgets that you can add to your own dashboard. Although we are
...
Give that a shot! Drag the sample widget from the sidebar and drop it on the dashboard on the right, try move things around, resize, and more! You can already feel the flexibility
of the dashboard that is so much different from other dashboards out there.

### It's a Web3 Search Engine

It's build-in search engine allows you to search for anything Web3 related, from wallet activities, tokens, to NFTs, to dApps, articles, Web3 real time feed and more.
...
Well, you don't really need this, but as a Web3 degen myself, I find myself constantly switching between different dApps/website everyday, and I find it really annoying to
...
related content too, X (Twitter) is my main source of latest Web3 things, but it can sometimes be really hard to find the right content, and I find myself constantly scrolling
...
subscribed to a few newletters, but I find myself not reading them at all after a few days.
